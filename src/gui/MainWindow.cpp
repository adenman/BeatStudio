...
void MainWindow::finalize()
{
	...
	{
		QMessageBox::critical(QApplication::activeWindow(), "Audio device setup failed",
...
void MainWindow::resetWindowTitle()
{
	...
	setWindowTitle( title + " - " + tr( "Beat Studio %1" ).arg( LMMS_VERSION ) );
}
...
void MainWindow::openProject()
{
	...
	{
		FileDialog ofd( this, tr( "Open Project" ), "", tr( "Beat Studio (*.mmp *.mmpz)" ) );
...
bool MainWindow::saveProjectAs()
{
	...
	VersionedSaveDialog sfd( this, optionsWidget, tr( "Save Project" ), "",
			tr( "Beat Studio Project" ) + " (*.mmpz *.mmp);;" +
				tr( "Beat Studio Project Template" ) + " (*.mpt)" );
...
void MainWindow::help()
{
	QMessageBox::information( this, tr( "Help not available" ),
				  tr( "Currently there's no help "
						  "available in Beat Studio.\n"
						  "Please visit "
						  "https://lmms.io/wiki "
						  "for documentation on the base engine." ),
				  QMessageBox::Ok );
}
